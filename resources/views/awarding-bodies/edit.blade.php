@extends('layouts.app')
@section('title', 'Update Awarding Body')
@section('content')
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-5 py-2">
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Edit Awarding Body: {{ $awardingBody->name }}</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('awarding-bodies.index')}}" class="text-muted text-hover-primary">
                        Awarding Bodies
                        </a>
                    </li>
                    <li class="breadcrumb-item">
                    ...
                    <li class="breadcrumb-item text-dark">{{ $awardingBody->name }}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                <div class="card-header cursor-pointer">
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Awarding Body Details</h3>
                    </div>
                </div>
                                ...
                                <div class="modal-body scroll-y pt-0 pb-15">
                                    <div class="mw-lg-600px mx-auto">
                                        <div class="text-center">
                                            <h1 class="mb-3">Delete <span class="text-danger">{{ $awardingBody->name }}</span>?</h1>
                                            <div class="text-muted fw-bold fs-5">
                                                Are you sure you want to delete {{ $awardingBody->name }}? This action cannot be undone.
                                            </div>
                                            <div class="text-center mt-10">
                                                {{ Form::model($awardingBody, array('route' => array('awarding-bodies.destroy', $awardingBody->id), 'method' => 'DELETE', 'class' => 'd-inline')) }}
