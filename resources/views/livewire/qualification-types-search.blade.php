<div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2"
    ...
    <!--begin::Form-->
    <div class="nav-group nav-group-outline mx-auto mb-10" data-kt-buttons="true">
        <a href="#" class="btn btn-color-gray-400 btn-active {{$selected == "Library" ? "active" : ""}} btn-active-secondary px-6 py-3 me-2"
           wire:click="openLibrary">Library</a>
        <a href="#" class="btn btn-color-gray-400 btn-active {{$selected == "Custom" ? "active" : ""}} btn-active-secondary px-6 py-3"
           wire:click="openCustom">Custom</a>
    </div>
