                    ...
                    <div class="card-header border-0 py-6 px-0">
                        <div class="card-title w-100">
                            <div class="row w-100">
                                ...
                                <div class="col-2">
                                    <input type="text" wire:model.lazy="start"
                                           class="form-control form-control-solid" id="expiryStart"
                                           placeholder="Start" autocomplete="off">
                                </div>
                                <div class="col-2">
                                    <input type="text" wire:model.lazy="end"
                                           class="form-control form-control-solid" id="expiryEnd"
                                ...
                                <tr class="">
                                    <td class="d-flex align-items-center border-bottom-0">
                                        <div class="d-flex flex-column">
                                            <a href="/tenders/{{ $item->id }}"
                                               class="text-gray-800 text-hover-primary p-2">{{ $item->name }}</a>
                                        </div>
                                    </td>
                                    <td class="">
                                        <div class="d-flex flex-column">
