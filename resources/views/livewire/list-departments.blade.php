<div>
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
            <div class="@if(Auth::user()->companies->first()->departments->count() == 0 ) card @endif">
                        ...
                        <table class="table align-middle table-hover table-rounded table-striped border gy-7 gs-7">
                            <thead>
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    <th class="min-w-125px pointer" wire:click="sortBy('name')">Department <i class="{{$sortDirection == "asc" ? 'fa fa-angle-down' : 'fa fa-angle-up'}}"></i></th>
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-end">
                                        <a href="/departments/{{ $item->id }}/" class="btn btn-secondary btn-sm">View</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
