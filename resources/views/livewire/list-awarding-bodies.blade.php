            ...
            <div class="@if(Auth::user()->companies->first()->awardingBodies->count() == 0 ) card @endif">
                        ...
                        <div class="row w-100">
                            <div class="col-3">
								<div class="d-flex align-items-center position-relative">
									...
									<input type="text" class="form-control form-control-solid ps-14" placeholder="Search Awarding Bodies" wire:model="searchTerm"/>
								</div>
							</div>
							<div class="col-2 mt-3">
                                <a href="{{route('awarding-bodies.index')}}">
                ...
                <div class="card-body p-0">
                    <div class="card-px text-center py-20 my-10">
                        <h2 class="fs-2x fw-bolder mb-10">Add Your First Awarding Body!</h2>
                        <p class="text-gray-400 fs-4 fw-bold mb-10">
                            It looks like you have not added any awarding body yet...
                        </p>
                        <a href="{{route('awarding-bodies.create')}}" class="btn btn-primary">Add Awarding Body</a>
                    </div>
                        ...
                        <table class="table align-middle table-hover table-rounded table-striped border gy-7 gs-7">
                            <thead>
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    <th class="min-w-125px pointer" wire:click="sortBy('name')">Awarding Bodies <i class="{{$sortDirection == "asc" ? 'fa fa-angle-down' : 'fa fa-angle-up'}}"></i></th>
