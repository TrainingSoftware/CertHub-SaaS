                            ...
                            <div class="px-9 pt-7 card-rounded h-275px w-100 bg-primary">
                                ...
                                <div class="d-flex text-center flex-column text-white pt-8">
                                    <span class="fw-bold fs-7">
                                        ...
                                        <span class="svg-icon svg-icon-white" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Price based on qualification(s) cost">
                            ...
                            <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1"
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap w-100">
                                        <div class="mb-1 pe-3 flex-grow-1">
                                            <a href="/reports/1"
                                                class="fs-5 text-gray-800 text-hover-primary fw-bolder">This Month</a>
                                            <div class="text-gray-400 fw-bold fs-7">{{$thisMonth->format('F, Y')}}</div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="fw-bolder fs-5 text-gray-800 pe-1">£{{ $monthlyTrainingSpend }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap w-100">
                                        <div class="mb-1 pe-3 flex-grow-1">
                                            <a href="/reports/2"
                                                class="fs-5 text-gray-800 text-hover-primary fw-bolder">Next Month</a>
                                            <div class="text-gray-400 fw-bold fs-7">{{$nextMonth->format('F, Y')}}</div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="fw-bolder fs-5 text-gray-800 pe-1">£{{ $nextMonthTrainingSpend
                                                }}</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap w-100">
                                        <div class="mb-1 pe-3 flex-grow-1">
                                            <a href="/reports/3"
                                                ...
                                                $thisQuarter->format('F') }}</a>
                                            <div class="text-gray-400 fw-bold fs-7">{{$thisQuarter->format('F, Y')}}
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="fw-bolder fs-5 text-gray-800 pe-1">£{{ $thirdMonthTrainingSpend
                                                }}</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card card-xl-stretch">
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted fw-bold fs-7">{{ $upcomingRenewalsCount }} qualifications due to
                                    expire between {{ $thisMonth->format('M, y') }} - {{ $thisQuarter->format('M, y')
                                    }}</span>
                            </h3>
                        </div>
                            ...
                            <div class="timeline-label">
                                ...
                                <div class="timeline-item">
                                    <div class="timeline-label fw-bolder text-gray-800 fs-6">{{
                                        $item->expiry_date->format('m/y')}}</div>
                                    <div class="timeline-badge">
                                        @if($item->expiry_date->format('m') === Carbon\Carbon::today()->format('m'))
                                        <i class="fa fa-genderless text-danger fs-1"></i>
                                        @elseif($item->expiry_date->format('m') ===
                                        Carbon\Carbon::today()->addMonth(1)->format('m'))
                                    ...
                                    <div class="fw-mormal timeline-content text-muted ps-3">
                                        <a href="/qualifications/{{ $item->id }}">
                                            <strong class="text-gray-800">{{ optional($item->employee)->firstname }} {{
                                                optional($item->employee)->lastname }}</strong>
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="form-check form-check-custom form-check-solid mx-5">
                                    <input class="form-check-input bg-success" type="checkbox" value="" checked
                                        disabled>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#" class="text-success text-hover-primary fw-bolder fs-6"><strike>Add
                                            Employee</strike></a>
                                    <span class="text-muted fw-bold d-block">Add your first employee</span>
                                </div>
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="flex-grow-1">
                                    <a href="/providers" class="text-gray-800 text-hover-primary fw-bolder fs-6">Add
                                        Provider</a>
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="flex-grow-1">
                                    <a href="/departments" class="text-gray-800 text-hover-primary fw-bolder fs-6">Add
                                        Department</a>
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="flex-grow-1">
                                    <a href="/awarding-bodies"
                                        class="text-gray-800 text-hover-primary fw-bolder fs-6">Add Awarding Body</a>
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="flex-grow-1">
                                    <a href="/qualificationtypes"
                                        class="text-gray-800 text-hover-primary fw-bolder fs-6">Add Qualification
                                        Type</a>
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="flex-grow-1">
                                    <a href="/qualifications"
                                        class="text-gray-800 text-hover-primary fw-bolder fs-6">Add Qualification</a>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <a href="/qualifications"
                                        class="text-success text-hover-primary fw-bolder fs-6"><strike>Add
                                            Qualification</strike></a>
                                    <span class="text-muted fw-bold d-block">Add your first qualification</span>
                                </div>
                                <span class="badge badge-success fs-8 fw-bolder">Completed</span>
                            </div>
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-bold fs-7">You have {{ $employees }} <a
                                        href="/employees">employees</a></span>
                            </h3>
                            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-trigger="hover" title="Click to add a Employee">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-45px me-5">
                                                        <span
                                                            class="symbol-label bg-info text-inverse-warning fw-bolder">{{
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-bold fs-7">You have {{ $qualifications }} <a
                                        href="/qualifications">qualifications</a></span>
                            </h3>
                            @if($qualifications > 0)
                            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-trigger="hover" title="Click to add a qualification">
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span href="#"
                                                    class="text-muted fw-bold text-hover-primary d-block fs-6">
                                                    {{ $item->updated_at->diffForHumans() }}
                                                </span>
                                            </td>
                                            <td>
