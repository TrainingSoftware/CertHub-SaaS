@extends('layouts.app')
@section('title', 'Report: Qualifications Expiring This Year')
@section('content')
        ...
        <div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
                ...
                <div class="page-title d-flex flex-column me-5 py-2">
                    <!--begin::Title-->
                    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Report: Qualifications Expiring This year</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="alert bg-light-danger border border-danger border-dashed d-flex flex-column flex-sm-row w-100 p-5 mb-10">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        ...
                        <!--end::Title-->
                        <!--begin::Content-->
                        <span>This report shows all qualifications expiring in the current year.</span>
                        <!--end::Content-->
                    </div>
                    <!--end::Wrapper-->
                </div>
