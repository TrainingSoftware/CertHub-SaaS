    ...
    <div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-5 py-2">
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Report: Qualifications Expiring Next Month</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    ...
                    <li class="breadcrumb-item text-dark">Qualifications Expiring Next Month</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="alert bg-light-danger border border-danger border-dashed d-flex flex-column flex-sm-row w-100 p-5 mb-10">
                ...
                <div class="d-flex flex-column pe-0 pe-sm-10">
                    ...
                    <span>This report shows all qualifications expiring next month.</span>
                </div>
            </div>
                ...
                <div class="col-md-3 offset-md-3 text-xl-left">
                    <div class="align-bottom text-right">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="{{ $startOfMonth->format('d') }} - {{ $endOfMonth->format('d') }} {{ $nextMonth->format('F, Y') }}" aria-label="Username" disabled/>
                        </div>
                    </div>
                </div>
            </div>
