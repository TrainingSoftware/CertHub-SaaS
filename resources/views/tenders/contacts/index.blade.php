            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
				<div class="card-header cursor-pointer">
					<div class="card-title m-0">
						<h3 class="fw-bolder m-0">{{ $tender->name }}'s Contacts</h3>
					</div>
					<div class="card-toolbar">
						<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
							<a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addTenderContact">
							...
							<div class="modal fade" id="addTenderContact" tabindex="-1" aria-hidden="true">
				...
				<div class="card-body p-9">
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
						...
						<tbody>
							@foreach($tender->contacts as $contact)
                            <tr>
                                <th>{{ $contact->firstname }} {{ $contact->lastname }}</th>
								<th>{{ $contact->phone }}</th>
								<th>{{ $contact->email }}</th>
								<th><a href="/tenders/{{ $tender->id }}/contacts/{{ $contact->id }}" class="btn btn-light btn-sm">View</a></th>
                            </tr>
                            @endforeach
						</tbody>
					</table>
