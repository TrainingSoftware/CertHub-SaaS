                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            {{ Form::text('start_date', date('d-m-Y'), ['class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0', 'id' => 'datepicker']) }}
                                        </div>
                                        <div class="form-group col-md-6">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center form-label">
                                            ...
                                            {{ Form::text('end_date', date('d-m-Y'), ['class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0', 'id' => 'datepicker']) }}
                                        </div>
                                    </div>
                                </div>
                                <!--end::Col-->
