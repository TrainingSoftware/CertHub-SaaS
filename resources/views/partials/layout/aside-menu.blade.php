        ...
        <div class="w-100 hover-scroll-overlay-y d-flex pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-rounded fw-bold" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ (request()->is('employees*')) ? 'hover show' : '' }}">
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ (request()->is('qualification*')) ? 'hover show' : '' }} ">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <div class="menu-sub menu-sub-accordion {{ (request()->is('qualifications*')) ? 'show' : '' }}">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{route('awarding-bodies.index')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Award Bodies</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ (request()->is('tenders*')) ? 'hover show' : '' }} ">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion {{ (request()->is('providers*')) ? 'show' : '' }}">
                        <div class="menu-item">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="/providers/create">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Create New</span>
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ (request()->is('settings*')) ? 'hover show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
    ...
    <div class="aside-footer flex-column-auto px-9" id="kt_aside_menu">
        <div class="d-flex flex-stack">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-2">
                    <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder lh-1">{{ Auth::user()->name
                        }}</a>
                    @if(!Auth::user()->isAdmin())
                    <span class="text-muted fw-bold d-block fs-7 lh-1">{{ Auth::user()->companies()->first()->name
                        }}</span>
                    @endif
                </div>
            </div>
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            <div class="symbol symbol-50px me-5">
                                <span class="symbol-label bg-info text-inverse-warning fw-bolder">{{
                                    Auth::user()->name[0] }}</span>
                            </div>
                            <div class="d-flex flex-column">
                                <div class="fw-bolder d-flex align-items-center fs-5">{{ Auth::user()->name }}</div>
                                <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ Auth::user()->email
                                    }}</a>
                            </div>
                        </div>
                    </div>
