                ...
                <div class="card-body py-10">
                    <div class="row">
                        <div class="col-md-6 pb-10 pb-lg-0">
                            ...
                            <button class="btn btn-primary btn-active-light-primary align-self-center" data-bs-toggle="modal" data-bs-target="#kt_modal_account_upgrade">Upgrade</button>
                                            ...
                                            <div class="mw-lg-600px mx-auto">
                                                <div class="text-center">
                                                    ...
                                                    <div class="text-center mt-10">
                                                        <!-- Form Open here -->
                                                        <button class="btn btn-primary btn-active-light-primary fw-bolder" type="submit">Confirm upgrade</button>
                                                        <!-- Form Close here -->
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="card-body py-10">
                    <div class="row">
                        <div class="col-md-6 pb-10 pb-lg-0">    
                            ...
                            <button class="btn btn-danger btn-active-light-danger align-self-center" data-bs-toggle="modal" data-bs-target="#kt_modal_confirm_delete">Deactivate account</button>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-800px">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y pt-0 pb-15">
                                            <div class="mw-lg-600px mx-auto">
                                                <div class="text-center">
                                                    <h1 class="mb-3">Deactivate <span class="text-danger">{{ Auth::user()->companies()->first()->name }}</span>?</h1>
                                                    ...
                                                    <div class="text-center mt-10">
                                                        <!-- Form Open here -->
                                                        <button class="btn btn-danger fw-bolder" type="submit">Confirm deactivation</button>
                                                        <!-- Form Close here -->
                                                    </div>
                                                </div>
                                            </div>
