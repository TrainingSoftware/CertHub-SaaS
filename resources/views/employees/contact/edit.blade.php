@extends('layouts.app')
@section('title', 'Update Tender Contact')
@section('content')
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
			<div class="page-title d-flex flex-column me-5 py-2">
				<h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Edit Contact: {{ $contact->firstname }} {{ $contact->lastname }}</h1>
				<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
						<a href="/employees/{{$employee->id}}/contacts" class="text-muted text-hover-primary">{{ $employee->firstname }}'s Contacts</a>
					</li>
					<li class="breadcrumb-item">
						<span class="bullet bg-gray-200 w-5px h-2px"></span>
					</li>
		...
		<div id="kt_content_container" class="container-xxl">
			<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
				...
				<div class="card-body p-9">
					{{ Form::model($contact, array('route' => array('employee.contact.update',$employee, $contact->id), 'method' => 'PATCH','enctype'=>'multipart/form-data')) }}
				...
				<div class="card-footer">
					...
					{{ Form::model($contact, array('route' => array('employee.contact.destroy',$employee, $contact), 'method' => 'DELETE', 'class' => 'd-inline')) }}
