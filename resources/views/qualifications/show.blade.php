...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
            ...
            @if(get_class($qualification->qualificationtype) == "App\Models\ExternalQualificationType" && $qualification->expiresInAMonth() && count($qualification->qualificationtype->courseMetas) > 0)
                @livewire('list-course-metas',['qualification' => $qualification->qualificationtype])
            @endif
        </div>
    </div>
</div>
